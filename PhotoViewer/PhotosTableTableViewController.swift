...
class PhotosTableTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        newPhoto = Photo(name: "A Joshua Tree", filename: "joshuatree", notes: "Where you learn that girl?")
        photos.append(newPhoto)
        
        newPhoto = Photo(name: "Sunset in Ventura", filename: "sunset", notes: "Yeezy taught me")
        photos.append(newPhoto)
        
        newPhoto = Photo(name: "Snowman at Lake Tahoe", filename: "snowman", notes: "They say your attitude determines your lattitude.")
        photos.append(newPhoto)
